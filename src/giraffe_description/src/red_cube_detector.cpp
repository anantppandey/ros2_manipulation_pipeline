...
//         // Publisher for full target pose in world frame
...
//                     // Transform to world frame for MoveIt planning
//                     geometry_msgs::msg::PointStamped world_point;
//                     try
//                     {
//                         world_point = tf_buffer_.transform(base_link_point, "world", std::chrono::milliseconds(100));
//                     }
//                     catch (tf2::TransformException &ex)
//                     {
//                         RCLCPP_WARN(this->get_logger(), "World transform failed: %s", ex.what());
//                         return;
//                     }

//                     // Determine orientation from the current end-effector pose
//                     geometry_msgs::msg::Quaternion ee_orientation;
//                     bool ee_orientation_valid = false;
//                     const std::string ee_frame = "wrist_2";
//                     try
//                     {
//                         auto ee_transform = tf_buffer_.lookupTransform("world", ee_frame, tf2::TimePointZero, std::chrono::milliseconds(100));
//                         ee_orientation = ee_transform.transform.rotation;
//                         ee_orientation_valid = true;
//                     }
//                     catch (const tf2::TransformException &ex)
//                     {
//                         RCLCPP_WARN(this->get_logger(), "End-effector TF lookup failed: %s", ex.what());
//                         // Fallback orientation if TF is not available
//                         ee_orientation.x = -0.706834;
//                         ee_orientation.y = 0.707368;
//                         ee_orientation.z = -0.002907;
//                         ee_orientation.w = -0.002876;
//                     }

//                     // Publish as a target pose in world frame using the end-effector orientation
//                     geometry_msgs::msg::PoseStamped target_pose;
//                     target_pose.header.stamp = msg->header.stamp;
//                     target_pose.header.frame_id = "world";
//                     target_pose.pose.position = world_point.point;
//                     target_pose.pose.position.z += 0.10; // approach above the cube
//                     target_pose.pose.orientation = ee_orientation;
...
//                                 "world: (%.4f, %.4f, %.4f), orientation=(%.6f, %.6f, %.6f, %.6f)",
